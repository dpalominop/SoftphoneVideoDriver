...
static void choose_display_name(VideoStream *stream){
    ...
    {stream->display_name=ms_strdup("MSDrawDibDisplay");
     ms_message("choose_display_name: MSDrawDibDisplay **********\n");
    }
#elif defined(ANDROID)
    {stream->display_name=ms_strdup("MSAndroidDisplay");
    ms_message("choose_display_name: MSAndroidDisplay **********\n");
   }
#elif __APPLE__ && !defined(__ios)
    {stream->display_name=ms_strdup("MSOSXGLDisplay");
    ms_message("choose_display_name: MSOSXGLDisplay **********\n");
   }
#elif defined (HAVE_XV)
    {stream->display_name=ms_strdup("MSX11Video");
    ms_message("choose_display_name: MSX11Video **********\n");
   }
#elif defined(HAVE_GL)
    {stream->display_name=ms_strdup("MSGLXVideo");
    ms_message("choose_display_name: MSGLXVideo **********\n");
   }
#elif defined(__ios)
    {stream->display_name=ms_strdup("IOSDisplay");
    ms_message("choose_display_name: IOSDisplay **********\n");
   }
#else
    {stream->display_name=ms_strdup("MSVideoOut");
        ms_message("choose_display_name: MSVideoOut **********\n");
    }
#endif
    ms_message("choose_display_name: NONE **********\n");
}
...
void video_stream_set_preview_corner(VideoStream *stream, int corner){
    MSFilter *out=stream->output;
    stream->corner = corner;
