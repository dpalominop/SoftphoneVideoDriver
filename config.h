...
#define LINPHONE_PLUGINS_DIR "/usr/local/NeoLine/lib/liblinphone/plugins"
...
#define PACKAGE_DATA_DIR "/usr/local/NeoLine/share"

/* Defines the place where locales can be found */
#define PACKAGE_LOCALE_DIR "/usr/local/NeoLine/share/locale"

/* Define to the full name of this package. */
#define PACKAGE_NAME "linphone"

/* Defines the place where linphone sounds are found */
#define PACKAGE_SOUND_DIR "/usr/local/NeoLine/share/sounds/linphone"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "linphone 3.7.0"
